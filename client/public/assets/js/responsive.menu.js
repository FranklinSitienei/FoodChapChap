...
(function ($, document, window) {
    var
            ...
            defaults = {
                ...
                easingOpen: 'swing',
                easingClose: 'swing',
                closedSymbol: '<i className="icon-keyboard_arrow_right"></i>',
                openedSymbol: '<i className="icon-keyboard_arrow_down"></i>',
                prependTo: '.main-nav',
                appendTo: '',
                parentTag: 'a',
                closeOnClick: false,
    ...
    Plugin.prototype.init = function () {
        ...
        $this.btn = $(
                ['<' + settings.parentTag + ' aria-haspopup="true" tabindex="0" className="' + prefix + '_btn ' + prefix + '_collapsed">',
